...
import currentPictureAddress from "./../../../../assets/Avatar1.png";
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-9 w-9">
          ...
          <div ref={fallbackRef} className="hidden">
            <BsPersonCircle color="#6d6dc3" className="w-full h-full" />
          </div>
          {/* </>
          ) : (
            <BsPersonCircle color="#6d6dc3" className="w-full h-full" />
      ...
      <Dropdown
        ...
        className="absolute rtl right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
        <div>
