...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-8xl mt-10">
        {[
          {
            title: "کارت اول",
          ...
          },
          {
            ...
            img: "https://4kwallpapers.com/images/walls/thumbs_3t/22085.jpg",
          },
          {
            title: "کارت سوم",
            desc: "توضیحی کوتاه درباره کارت سوم",
            img: "https://4kwallpapers.com/images/walls/thumbs_3t/22153.jpg",
          },
          {
            title: "کارت سوم",
            desc: "توضیحی کوتاه درباره کارت سوم",
