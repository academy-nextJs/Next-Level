...
//         <button className="custom-prev bg-gray-200 w-10 h-10 rounded-full flex items-center justify-center shadow-md hover:bg-gray-300 transition">
//           →
//         </button>
//         <button className="custom-next bg-gray-200 w-10 h-10 rounded-full flex items-center justify-center shadow-md hover:bg-gray-300 transition">
//           ←
//         </button>
//       </div>
...
//                 className={`
//                   drop-shadow group aspect-square
