    ...
    <div className="lg:mx-24 mt-12 ">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 ">
        ...
        >
          ...
          >
            <button className="group relative bg-gradient-to-br from-amber-300 via-amber-400 to-amber-500 text-amber-900 px-4 py-2 rounded-[3rem] text-xl md:text-2xl font-bold tracking-wide mt-10 transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] hover:scale-[1.03] hover:shadow-2xl hover:shadow-amber-500/30 overflow-hidden isolate">
