...
const LandingCard = () => {
 ...
 <Image
   ...
   <p className='pr-4 text-[20px] text-[#444444] mt-2 flex justify-end  '>ویلای دوبلکس ساحلی</p>
   <p className='pr-4  text-[18px] text-[#666666] flex justify-end gap-1  '>مازندران , بابلسر 
   ...
   <div className='flex gap-5 mt-3 justify-evenly '>
     <h2 className='text-[#C8C8C8] text-[16px] line-through  '>۱.۷۵۰.۰۰۰ ت</h2>
